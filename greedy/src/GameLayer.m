...
- (id) initWithEnvironment:(GameEnvironment *) environment level:(int)l
{
    ...
    if( (self=[super init])) {
        ...
        [[GameObjectCache sharedGameObjectCache] addBackground:[[[Background alloc] initWithLayers:[level backgroundLayers]] autorelease]];
        [sharedGameScene addChild:sharedBackground z:0];
